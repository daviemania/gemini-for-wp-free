...
// Exit condition for manual runs
if (require.main === module) {
  runBackup().then(() => {
    console.log('🏁 Backup completed, exiting...');
    process.exit(0);
  }).catch(error => {
    console.error('💥 Backup failed, exiting...', error);
    process.exit(1);
  });
}
console.log('🔮 Intelligent backup system is running...');
console.log('💡 Manual backup: node backup-scheduler.js');
console.log('⏰ Scheduled: Daily at 2 AM');
